...
public class CPUSimulator
{
	 ...
	 *            阻塞队列
	 */
	public void requestRun(ProcessSimulator processSimulator, PriorityBlockingQueue<ProcessSimulator> readyQueue,
			PriorityBlockingQueue<ProcessSimulator> blockingQueue)
	{
		// 此时CPU将不空闲
		isCPUFree = false;
		// 计数器用于中断一个时间片
		...
		blockingQueue.add(processSimulator);
		processSimulator.setBlock();
		isCPUFree = true;
	}
